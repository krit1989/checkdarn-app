...
import '../models/event_model.                  // Header with "All" toggle
                  Container(
                    padding: const EdgeInsets.only(left: 18, right: 8, top: 6, bottom: 6), // ลด right padding เพื่อให้ Switch ขยับซ้ายได้
                    decoration: BoxDecoration(
                      border: Border(
                        bottom:
                            BorderSide(color: Colors.grey.shade200, width: 1),
                      ),
                    ),ss CategorySelectorDialog extends StatefulWidget {
                ...
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.symmetric(
                        horizontal: 18,
                        vertical: 6), // เปลี่ยนจาก all(6) เป็น symmetric
                    decoration: BoxDecoration(
                      border: Border(
                        bottom:
                            BorderSide(color: Colors.grey.shade200, width: 1),
                    ...
                    child: Row(
                      children: [
                        const SizedBox(
                            width:
                                10), // เพิ่มเพื่อให้ "เลือกประเภท" อยู่ในแนวเดียวกับอีโมจิ
                        const Expanded(
                          child: Text(
                            'เลือกประเภท',
                            style: TextStyle(
                        ...
                        const SizedBox(width: 0), // ลดเป็น 0 เพื่อให้ Switch ขยับซ้ายสุด
                        Transform.scale(

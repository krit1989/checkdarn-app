...
class _CameraReportFormWidgetState extends State<CameraReportFormWidget> {
  ...
  LatLng? _selectedLocation; // เปลี่ยนจาก TextEditingController เป็น LatLng
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<CameraReportType>(
                ...
                isExpanded: true, // แก้ไข overflow
  ...
  Future<void> _submitReport() async {
    ...
    if (_selectedLocation == null) {
      setState(() => _isSubmitting = true); // เพื่อแสดง error message

...
void main() {
  ...
  group('SpeedCameraLogic.smoothHeading', () {
    ...
    test('should be more responsive at higher speeds', () {
      ...
      // ความเร็วสูง = การตอบสนองสูง = smoothing น้อยลง
      // ทดสอบว่าผลลัพธ์อยู่ในช่วงที่สมเหตุสมผล
      expect(slowResult, greaterThan(0));
      expect(slowResult, lessThan(10));
      expect(fastResult, greaterThan(0));
      expect(fastResult, lessThan(10));
    });
